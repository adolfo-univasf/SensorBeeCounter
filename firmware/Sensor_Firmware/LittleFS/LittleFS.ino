...
void setup()
{
   ...
   // writeFile(LittleFS, "/Dados1.csv", "Data, Entradas, Saidas, Bateria, Erros");
   // writeFile(LittleFS, "/Dados2.csv", "Data, Entradas, Saidas, Bateria, Erros");
   // writeFile(LittleFS, "/Dados3.csv", "Data, Entradas, Saidas, Bateria, Erros");
   // writeFile(LittleFS, "/Dados4.csv", "Data, Entradas, Saidas, Bateria, Erros");
   // writeFile(LittleFS, "/Dados5.csv", "Data, Entradas, Saidas, Bateria, Erros");
    //listDir(LittleFS, "/mydir", 1); // List the directories up to one level beginning at the root directory
